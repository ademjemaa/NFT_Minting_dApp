...
export declare const loginInfoSlice: import("@reduxjs/toolkit").Slice<LoginInfoStateType, {
    ...
    setLoginExpiresAt: (state: LoginInfoStateType, action: PayloadAction<number>) => void;
}, "loginInfoSlice">;
export declare const setLoginMethod: import("@reduxjs/toolkit").ActionCreatorWithPayload<LoginMethodsEnum, string>, setWalletConnectLogin: import("@reduxjs/toolkit").ActionCreatorWithPayload<WalletConnectLoginType | null, string>, setLedgerLogin: import("@reduxjs/toolkit").ActionCreatorWithPayload<LedgerLoginType | null, string>, setTokenLogin: import("@reduxjs/toolkit").ActionCreatorWithPayload<TokenLoginType, string>, setTokenLoginSignature: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, string>, setWalletLogin: import("@reduxjs/toolkit").ActionCreatorWithPayload<LoginInfoType | null, string>, setLoginExpiresAt: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, string>;
